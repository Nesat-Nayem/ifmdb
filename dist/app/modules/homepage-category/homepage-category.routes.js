...
exports.homepageCategoryRouter = void 0;
const express_1 = __importDefault(require("express"));
const homepage_category_controller_1 = require("./homepage-category.controller");
 ...
 */
router.post('/', (0, authMiddleware_1.auth)('admin'), cloudinary_1.upload.single('image'), homepage_category_controller_1.createHomepageCategory);
/**
 * @swagger
 * /v1/api/homepage-categories:
 *   get:
 ...
 *                     $ref: '#/components/schemas/HomepageCategory'
 */
router.get('/', homepage_category_controller_1.getAllHomepageCategories);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:id', homepage_category_controller_1.getHomepageCategoryById);
/**
 * @swagger
 * /v1/api/homepage-categories/{id}:
 *   put:
 ...
 *         description: Unauthorized
 */
router.put('/:id', (0, authMiddleware_1.auth)('admin'), cloudinary_1.upload.single('image'), homepage_category_controller_1.updateHomepageCategoryById);
/**
 * @swagger
 * /v1/api/homepage-categories/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id', (0, authMiddleware_1.auth)('admin'), homepage_category_controller_1.deleteHomepageCategoryById);
exports.homepageCategoryRouter = router;
