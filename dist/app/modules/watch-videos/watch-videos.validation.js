...
const updateWatchVideoValidation = zod_1.z.object({
    body: zod_1.z.object({
        ...
        channelId: zod_1.z.string().optional().nullable(),
        ...
        trailerUrl: zod_1.z.string().optional().nullable(),
        cloudflareVideoUid: zod_1.z.string().optional().nullable(),
        cloudflareTrailerUid: zod_1.z.string().optional().nullable(),
        seasons: zod_1.z.array(seasonSchema).optional(),
        thumbnailUrl: zod_1.z.string().optional().nullable(),
        posterUrl: zod_1.z.string().optional().nullable(),
        backdropUrl: zod_1.z.string().optional().nullable(),
        galleryImages: zod_1.z.array(zod_1.z.string()).optional(),
        duration: zod_1.z.number().min(0).optional(),
        releaseDate: zod_1.z.string().optional().nullable(),
        ...
        certification: zod_1.z.string().optional().nullable(),
        director: zod_1.z.string().optional().nullable(),
        producer: zod_1.z.string().optional().nullable(),
        ...
        homeSection: zod_1.z.string().optional().nullable(),
        rentalDays: zod_1.z.number().min(0).optional().nullable(),
    }),
});
