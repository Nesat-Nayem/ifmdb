...
const channelSubscriptionSchema: Schema = new Schema(
  {
    channelId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'Channel',
...
// Watch Video Interface
export interface IWatchVideo extends Document {
  title: string;
  description: string;
  ...
  // Duration & Release
  duration: number; // For single video (in seconds), for series it's total duration
  releaseDate: Date;
  
  // Pricing
  isFree: boolean;
  defaultPrice: number;
  countryPricing: typeof CountryPricingSchema[];
...
// Watch Video Schema
const watchVideoSchema: Schema = new Schema(
  {
    title: {
      type: String,
...
const videoPurchaseSchema: Schema = new Schema(
  {
    userId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'User',
...
const videoPaymentTransactionSchema: Schema = new Schema(
  {
    purchaseId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'VideoPurchase',
...
const videoWatchHistorySchema: Schema = new Schema(
  {
    userId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'User',
...
const watchVideoCategorySchema: Schema = new Schema(
  {
    name: {
      type: String,
...
// Video Like Schema
const videoLikeSchema: Schema = new Schema(
  {
    videoId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'WatchVideo',
...
export const WatchVideo = mongoose.model<IWatchVideo>('WatchVideo', watchVideoSchema);
export const VideoPurchase = mongoose.model('VideoPurchase', videoPurchaseSchema);
export const VideoPaymentTransaction = mongoose.model('VideoPaymentTransaction', videoPaymentTransactionSchema);
...
export const WatchVideoCategory = mongoose.model('WatchVideoCategory', watchVideoCategorySchema);
