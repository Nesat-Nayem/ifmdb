...
const updateWatchVideoValidation = z.object({
  body: z.object({
    ...
    cloudflareVideoUid: z.string().optional().nullable(),
    cloudflareTrailerUid: z.string().optional().nullable(),
    seasons: z.array(seasonSchema).optional(),
    ...
    homeSection: z.string().optional().nullable(),
    rentalDays: z.number().min(0).optional().nullable(),
  }),
});
...
const createPaymentOrderValidation = z.object({
  body: z.object({
    ...
    customerDetails: z.object({
      ...
      phone: z.string().optional().default(''), // Phone is optional - Razorpay will collect if needed
    }),
