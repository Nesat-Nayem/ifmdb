...
import { createOnboarding, deleteOnboardingById, getAllOnboarding, getOnboardingById, updateOnboardingById } from './onboarding.controller';
 ...
 */
router.post('/', auth('admin'), upload.single('image'), createOnboarding);
 ...
 *                   $ref: '#/components/schemas/Onboarding'
 */
router.put('/:id', auth('admin'), upload.single('image'), updateOnboardingById);
 ...
 *         description: Deleted
 */
router.delete('/:id', auth('admin'), deleteOnboardingById);
